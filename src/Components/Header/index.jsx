...
import { FiBriefcase, FiCode, FiHome, FiMenu, FiMessageSquare, FiUser, FiX } from "react-icons/fi";
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="w-15 h-8 sm:w-18 sm:h-10 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg sm:text-xl">Areesha</span>
            </div>
