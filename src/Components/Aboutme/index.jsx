...
const AboutMe = () => {
  ...
  const downloadCV = useCallback(() => {
    ...
    link.href = "/Areesha_Badar_Resume-1 (1).pdf";
    link.download = "Areesha_Badar_Resume-1 (1).pdf";
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                I'm Areesha, a passionate technologist
              </h2>
            ...
            <div>
              ...
              <div>
              <span className="font-semibold text-white" >BS Software Engineering</span>
              </div>
              <div>
              <span className=" mt-4 font-semibold text-white" >Comsats University Islamabad</span>
              </div>
              <div>
              <p className="mt-2 text-sm sm:text-base text-white" >2025 - Present  </p>
              </div>
              <div>
              <p className="mt-2 text-sm sm:text-base text-white" >CGPA: 3.94/4.0  </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 pt-4">
              <a
                href="https://github.com/areeshabadar-29"
                target="_blank"
