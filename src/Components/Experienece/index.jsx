...
import { FiBriefcase, FiCalendar, FiCode, FiExternalLink, FiTrendingUp } from "react-icons/fi";
...
const experiences = [
  {
    ...
    skills: ["React", "Node.js", "REST APIs", " Express.js", "MongoDB", "Responsive Design"],
    type: "Startup",
    icon: <FiCode />,
