  ...
  const socialLinks = [
    {
      ...
      url: "https://github.com/areeshabadar-29",
    ...
    },
    {
      ...
      url: "https://www.linkedin.com/in/areesha-badar-7b948b334/",
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="text-center md:text-left">
            <p className="text-gray-400">
              ...
              <span className="text-cyan-400 font-medium">Areesha Badar</span>
            </p>
          </div>
